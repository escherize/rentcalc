...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj8450 = {};return obj8450;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__4967__auto__ = this$;if(and__4967__auto__)
...
{var x__5606__auto__ = (((this$ == null))?null:this$);return (function (){var or__4979__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__5606__auto__)]);if(or__4979__auto__)
{return or__4979__auto__;
} else
{var or__4979__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__4979__auto____$1)
...
return (function (p__8451){var vec__8452 = p__8451;var k = cljs.core.nth.call(null,vec__8452,(0),null);var v = cljs.core.nth.call(null,vec__8452,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__8453){var vec__8454 = p__8453;var k = cljs.core.nth.call(null,vec__8454,(0),null);var v = cljs.core.nth.call(null,vec__8454,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
