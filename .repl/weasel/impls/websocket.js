...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj9729 = {};return obj9729;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__4967__auto__ = this$;if(and__4967__auto__)
...
{var x__5606__auto__ = (((this$ == null))?null:this$);return (function (){var or__4979__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__5606__auto__)]);if(or__4979__auto__)
{return or__4979__auto__;
} else
{var or__4979__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__4979__auto____$1)
...
return (function (p__9730){var vec__9731 = p__9730;var k = cljs.core.nth.call(null,vec__9731,(0),null);var v = cljs.core.nth.call(null,vec__9731,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
